...
execute_process(
  COMMAND "/usr/bin/git" --git-dir=.git show-ref "v1.7.1"
  WORKING_DIRECTORY "/home/sujan/CLionProjects/Talos/cmake-build-debug/_deps/whisper-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/sujan/CLionProjects/Talos/cmake-build-debug/_deps/whisper-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/sujan/CLionProjects/Talos/cmake-build-debug/_deps/whisper-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
