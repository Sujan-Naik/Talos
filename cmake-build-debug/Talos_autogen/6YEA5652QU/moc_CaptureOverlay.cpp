...
Q_CONSTINIT static const qt_meta_stringdata_CaptureOverlay_t qt_meta_stringdata_CaptureOverlay = {
    {
        ...
        QT_MOC_LITERAL(15, 13),  // "textExtracted"
        QT_MOC_LITERAL(29, 0),  // ""
...
void CaptureOverlay::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->textExtracted((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (CaptureOverlay::*)(const QString & );
            if (_t _q_method = &CaptureOverlay::textExtracted; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void CaptureOverlay::textExtracted(const QString & _t1)
{
